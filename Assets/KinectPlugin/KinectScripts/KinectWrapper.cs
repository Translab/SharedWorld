...
public class KinectWrapper
{
	...
	/////mengyu's hack/////
	[DllImport(@"Kinect10.dll", EntryPoint = "NuiTransformDepthImageToSkeleton")]
	public static extern Vector4 NuiTransformDepthImageToSkeleton(long lDepthX, long lDepthY, ushort usDepthValue);
	[DllImport(@"Kinect10.dll", EntryPoint = "NuiDepthPixelToPlayerIndex")]
	public static extern ushort NuiDepthPixelToPlayerIndex(ushort packedDepth);
